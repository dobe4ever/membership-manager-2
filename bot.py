...
# Back button (simulates back navigation)
...
# What to do when user selects a membership package (3, 6, 12 Months)
...
# What to do when user selects a payment method (BTC, BCH, ETH)
